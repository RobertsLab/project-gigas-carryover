...
plot8<-replicates%>%
  ...
  xlab("Life Stage")+
  scale_x_discrete(limits=c("spat", "seed", "juvenile", "adult"), labels=c("Spat", "Seed", "Juvenile", "Adult"))+
  theme_classic()+
  theme(
    text=element_text(size=12, color="black"), 
...
ggsave(plot=plot8, "lifestage_carryover/output/size/lifestage_growth.png", width=5, height=4)
```