  ...
  for (conditioning in unique_conditioning_treatments) {
    ...
    if (length(unique_treatments) >= 2) {
      ...
      for (pair in treatment_pairs) {
        ...
        acute_treatment_t_test_results_list[[paste(stage, conditioning, treatment1, treatment2, sep = ".")]] <- t_test_results
      }
    }
  }
}
...
# View the results
print(acute_treatment_within_life_stage_condiitioning_t_test_results_df)
```
