...
```{r delta-Cq-boxplots-acute-treatment}
# Create box plots for each comparison
...
```{r barplot-fold-change-conditioning, echo=FALSE}
...
```{r lineplot-fold-change-conditioning, echo=FALSE}
...
```{r barplot-fold-change-acute, echo=FALSE}
# Create the bar plot
